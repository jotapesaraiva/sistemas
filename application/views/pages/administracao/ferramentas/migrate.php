                ...
                <div id="msg-migrate">
                    <div class="msg">
                        <div class="alert alert-info">
                            <strong>Info</strong><br> A versão atual da migração é
...
<script>
    $(document).ready(function () {
        ...
        btn_migrate.click(function () {
            ...
            $.when($.ajax("<?= site_url('administracao/ferramentas/migrate/token') ?>", {
                cache: false,
                error: function () {
                ...
                console.log(d);
                $.post("<?= site_url('administracao/ferramentas/migrate/post?dbgroup=' . $active_group) ?>", d, function (r) {
                    console.log(r);
