...
$(document).ready(function() {
    table = $('#table').DataTable({
        ...
        "ajax": {
            url : href+"/servidor_list",//json datasource
...
function edit_person(id) {
    ...
    $.ajax({
        url : href+"/servidor_edit/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            $('[name="id"]').val(data.id_servidor);
            ...
            $('[name="ip"]').val(data.ip_servidor);
            $('[name="hostname"]').val(data.hostname_servidor);
            $('[name="so"]').val(data.so_servidor);
            $('[name="memoria"]').val(data.memoria_servidor);
            $('[name="processador"]').val(data.processador_servidor);
            $('[name="dominio"]').val(data.dominio_servidor);
...
function save(){
    ...
    var url;
    if(save_method == 'add') {
        url = href+"/servidor_add";
    } else {
        url = href+"/servidor_update";
    }
