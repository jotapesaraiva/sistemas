...
class Migrate extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['assets'] = [
            'bootstrap_css' => base_url('assets/global/plugins/bootstrap/css/bootstrap.min.css'),
            'bootstrap_js'  => base_url('assets/global/plugins/bootstrap/js/bootstrap.min.js'),
            'jquery'        => base_url('assets/global/plugins/jquery.min.js'),
        ];
        ...
        $this->load->view('pages/administracao/ferramentas/migrate', $data);
    }
