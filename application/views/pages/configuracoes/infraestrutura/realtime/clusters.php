            ...
            <form method="post">
                        ...
                        <div class="col-md-3">
                          ...
                          <!-- <select name="myselect" class="bs-select form-control bs-select-hidden" id="selector"> -->
                              ...
                              <option value="10.3.1.177">WTeste</option>
                          </select>
                        </div>
            </form>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa icon-screen-desktop"></i> Clusters</div>
                        <div class="tools"> </div>
                    </div>
...
<!-- /* Location: ./application/views/pages/configuracoes/infraestrutura/weblogic/clusters.php */ -->