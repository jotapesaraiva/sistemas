...
$(document).ready(function() {
    table = $('#table').DataTable({
        ...
        "ajax": {
            url : href+"/contexto_list",//json datasource
...
function add_person() {
    ...
    $('.modal-title').text('Adicionar contexto'); // Set Title to Bootstrap modal title
}
...
function edit_person(id) {
    ...
    $.ajax({
        url : href+"/contexto_edit/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            $('[name="id"]').val(data.id_contexto);
            $('[name="nome"]').val(data.nome_contexto);
...
function save(){
    ...
    var url;
    if(save_method == 'add') {
        url = href+"/contexto_add";
    } else {
        url = href+"/contexto_update";
    }
