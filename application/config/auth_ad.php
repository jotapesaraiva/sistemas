...
$config['start_ou'] = '';
//'OU=SEFA-PA,DC=sefa,DC=pa,DC=gov,DC=br';

// admin_group: group administrador of systema
$config['admin_group'] = 'Operadores';

// proxy_user: the (distinguished) username of the user that does the querying (AD generally does not allow anonymous binds)
$config['proxy_user'] = 'dokuwiki@sefa.pa.gov.br';

// proxy pass: the password for the proxy_user
$config['proxy_pass'] = 'wikidoku';
