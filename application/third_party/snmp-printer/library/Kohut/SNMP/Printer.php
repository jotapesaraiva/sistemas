 ...
 */
 require_once '/var/www/html/noc/application/third_party/snmp-printer/library/Kohut/SNMP/Abstract.php';
...
class Kohut_SNMP_Printer extends Kohut_SNMP_Abstract
{
     ...
     */
    const SNMP_PRINTER_LOCATION                       = 'SNMPv2-MIB::sysLocation.0';
    // const SNMP_PRINTER_FACTORY_ID                  = '.1.3.6.1.2.1.1.1.0';
    const SNMP_PRINTER_FACTORY_ID                     = 'SNMPv2-SMI::enterprises.641.6.2.3.1.4.1';
    ...
    const SNMP_PRINTER_SERIAL_NUMBER                  = 'SNMPv2-SMI::enterprises.641.6.2.3.1.5.1';
    const SNMP_PRINTER_VENDOR_NAME                    = '.1.3.6.1.2.1.43.9.2.1.8.1.1';
    const SNMP_NUMBER_OF_PRINTED_PAPERS               = '.1.3.6.1.2.1.43.10.2.1.4.1.1';
    const SNMP_NUMBER_OF_PRINTED_PAPERS_MONO          = 'SNMPv2-SMI::enterprises.641.2.1.5.2.0';
    const SNMP_NUMBER_OF_PRINTED_PAPERS_COLOR         = 'SNMPv2-SMI::enterprises.641.2.1.5.3.0';
    ...
    /**
     *  Function get location of printer
     *
     * @return string
     */
    public function getLocation()
    {
        return $this->getSNMPString(self::SNMP_PRINTER_LOCATION);
    }
    ...
    public function getNumberOfPrintedPapers()
    {
        ...
        $numberOfPrintedPapers = $this->get(self::SNMP_NUMBER_OF_PRINTED_PAPERS_MONO);
    ...
    public function getNumberOfPrintedPapersColor()
    {
        snmp_set_quick_print(true);
        $numberOfPrintedPapers = $this->get(self::SNMP_NUMBER_OF_PRINTED_PAPERS_COLOR);
        snmp_set_quick_print(false);
