...
$(document).ready(function() {
    table = $('#table').DataTable({
        ...
        "ajax": {
            url : href+"/usuario_list",//json datasource
...
function edit_person(id) {
    ...
    $.ajax({
        url : href+"/usuario_edit/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            console.log(data);
            $('[name="id"]').val(data.id_usuario);
            $('[name="nome"]').val(data.nome_usuario);
            $('[name="email"]').val(data.email_usuario);
            $('[name="login"]').val(data.login_usuario);
            $('[name="ativo"]').val(data.ativo_usuario);
...
function save(){
    ...
    var url;
    if(save_method == 'add') {
        url = href+"/usuario_add";
    } else {
        url = href+"/usuario_update";
    }
