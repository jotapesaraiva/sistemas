...
function add_person() {
    ...
    $('.modal-title').text('Adicionar perfil'); // Set Title to Bootstrap modal title
}
...
function edit_person(id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('.modal-title').text('Editar perfil'); // Set title to Bootstrap modal title
        },
