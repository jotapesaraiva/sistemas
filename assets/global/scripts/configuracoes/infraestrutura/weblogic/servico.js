...
$(document).ready(function() {
    table = $('#table').DataTable({
        ...
        "ajax": {
            url : href+"/servico_list",//json datasource
...
function edit_person(id) {
    ...
    $.ajax({
        url : href+"/servico_edit/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            $('[name="id"]').val(data.servico.id_servico);
            $('[name="sistema"]').selectpicker('val', data.servico.id_sistema);
            $('[name="aplicacao"]').val(data.servico.nome_servico);
            $('[name="versao"]').val(data.servico.versao_servico);
            $('[name="cluster"]').selectpicker('val', data.alvo);
            $('[name="weblogic"]').selectpicker('val', data.servico.id_weblogic);
...
function save(){
    ...
    var url;
    if(save_method == 'add') {
        url = href+"/servico_add";
    } else {
        url = href+"/servico_update";
    }
