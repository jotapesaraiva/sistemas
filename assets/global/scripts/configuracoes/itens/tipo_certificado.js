...
$(document).ready(function() {
    table = $('#table').DataTable({
        ...
        "ajax": {
            url : href+"/tipo_certificado_list",//json datasource
...
function add_person() {
    ...
    $('.modal-title').text('Adicionar tipo_certificados'); // Set Title to Bootstrap modal title
}
...
function edit_person(id) {
    ...
    $.ajax({
        url : href+"/tipo_certificado_edit/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            $('[name="id"]').val(data.id_tipo_certificado);
            $('[name="nome"]').val(data.nome_tipo_certificado);

            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Editar tipo_certificados'); // Set title to Bootstrap modal title
        },
...
function save(){
    ...
    var url;
    if(save_method == 'add') {
        url = href+"/tipo_certificado_add";
    } else {
        url = href+"/tipo_certificado_update";
    }
...
function delete_person(id){
    if(confirm('Você tem certeza que quer deletar o item?')) {
        ...
        $.ajax({
            url : href+"/tipo_certificado_delete/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
