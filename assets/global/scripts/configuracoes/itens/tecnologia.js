...
$(document).ready(function() {
    table = $('#table').DataTable({
        ...
        "ajax": {
            url : href+"/tecnologia_list",//json datasource
...
function add_person() {
    ...
    $('.modal-title').text('Adicionar tecnologias'); // Set Title to Bootstrap modal title
}
...
function edit_person(id) {
    ...
    $.ajax({
        url : href+"/tecnologia_edit/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            $('[name="id"]').val(data.id_tecnologia);
            $('[name="nome"]').val(data.nome_tecnologia);

            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Editar tecnologias'); // Set title to Bootstrap modal title
        },
...
function save(){
    ...
    var url;
    if(save_method == 'add') {
        url = href+"/tecnologia_add";
    } else {
        url = href+"/tecnologia_update";
    }
