...
$(document).ready(function() {
    table = $('#table').DataTable({
        ...
        "ajax": {
            url : href+"/clusters_list/"+ value,//json datasource
    ...
    $('select#selector').change(function(){
        value = $(this).val();
        console.log(value);
        table.ajax.url( href+"/clusters_list/"+ value ).load();
    });
});
...
function edit_person(id) {
    ...
    $.ajax({
        url : href+"/clusters_edit/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            $('[name="id"]').val(data.clusters.id_clusters);
            $('[name="sistema"]').selectpicker('val', data.clusters.id_sistema);
            $('[name="aplicacao"]').val(data.clusters.nome_clusters);
            $('[name="versao"]').val(data.clusters.versao_clusters);
            $('[name="cluster"]').selectpicker('val', data.alvo);
            $('[name="weblogic"]').selectpicker('val', data.clusters.id_weblogic);
...
function save(){
    ...
    var url;
    if(save_method == 'add') {
        url = href+"/clusters_add";
    } else {
        url = href+"/clusters_update";
    }
