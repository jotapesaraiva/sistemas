...
$(document).ready(function() {
    table = $('#table').DataTable({
        ...
        "ajax": {
            url : href+"/api_list/"+ value,//json datasource
    ...
    $('select#selector').change(function(){
        value = $(this).val();
        console.log(value);
        table.ajax.url( href+"/api_list/"+ value ).load();
    });
});
...
function edit_person(id) {
    ...
    $.ajax({
        url : href+"/api_edit/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            $('[name="id"]').val(data.api.id_api);
            $('[name="sistema"]').selectpicker('val', data.api.id_sistema);
            $('[name="aplicacao"]').val(data.api.nome_api);
            $('[name="versao"]').val(data.api.versao_api);
            $('[name="cluster"]').selectpicker('val', data.alvo);
            $('[name="weblogic"]').selectpicker('val', data.api.id_weblogic);
